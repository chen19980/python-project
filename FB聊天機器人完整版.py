...
#=====================================
client = pymongo.MongoClient("mongodb+srv://test2:GzJegLMvN0tzp39Q@cluster0.jgt9o.mongodb.net/?retryWrites=true&w=majority", tlsCAFile=certifi.where())
db = client.car
col = db.carlist

app = Flask(__name__)
PAGE_ACCESS_TOKEN = "EAAZAt41d1JvQBAAyDeaaIUUONp2NKiTOkqBpzZBvbqcSKrvx4I1V5cNIoCClTMoZBIx5zi8JUWIiJm58vkx8g8jMbekCAffr1jZADoiUmFyulxQaSliqC2ZB3ESC77H0mpxrywmUPObzhsW47brBgWvbnqzW1L5Sgk4vYw4DVJ3trEtpNQcAd"
